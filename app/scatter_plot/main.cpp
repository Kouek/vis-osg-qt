...
static const std::string volDPath = DATA_PATH_PREFIX"vis-osg-scatter-plot/ellipse753.txt";
...
int main(int argc, char** argv)
{
	...
	std::string errMsg;
	{
		auto volDiscreteDat = SciVis::OSGLoader::PointCloud::LoadFromFile(volDPath);
		if (!errMsg.empty())
			goto ERR;
