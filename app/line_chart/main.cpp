...
static const std::string volDPath0 = DATA_PATH_PREFIX"vis-osg-scatter-plot/linechart0.txt";
static const std::string volDPath1 = DATA_PATH_PREFIX"vis-osg-scatter-plot/linechart1.txt";
static const std::string volDPath2 = DATA_PATH_PREFIX"vis-osg-scatter-plot/linechart2.txt";
static const std::string volDPath3 = DATA_PATH_PREFIX"vis-osg-scatter-plot/linechart3.txt";
...
int main(int argc, char** argv)
{
	...
	std::string errMsg;
	{
		auto volDiscreteDat0 = SciVis::OSGLoader::PointCloud::LoadFromFile(volDPath0);
		if (!errMsg.empty())
			goto ERR;
		...
		auto volDiscreteDat1 = SciVis::OSGLoader::PointCloud::LoadFromFile(volDPath1);
		if (!errMsg.empty())
			goto ERR;
		...
		auto volDiscreteDat2 = SciVis::OSGLoader::PointCloud::LoadFromFile(volDPath2);
		if (!errMsg.empty())
			goto ERR;
		...
		auto volDiscreteDat3 = SciVis::OSGLoader::PointCloud::LoadFromFile(volDPath3);
		if (!errMsg.empty())
			goto ERR;
